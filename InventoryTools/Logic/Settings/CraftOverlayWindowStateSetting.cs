...
{
    public CraftOverlayWindowStateSetting(ILogger<CraftOverlayWindowStateSetting> logger, ImGuiService imGuiService, ILocalizationService localizationService) : base("CraftOverlayWindowState", "Window State", "The current state of the craft overlay window.", CraftOverlayWindowState.Single, new Dictionary<CraftOverlayWindowState, string>()
    {
        { CraftOverlayWindowState.Collapsed, "Collapsed"},
        { CraftOverlayWindowState.Single, "Single"},
        { CraftOverlayWindowState.List, "Expanded"},
    }, SettingCategory.None, SettingSubCategory.None, "1.11.0.8", logger, imGuiService, localizationService)
    {
    }
}